...
__当前版本:__ `V1-20241229` __开发文档:__ 暂无(赶工中..ing)
...
目前主要兼容 __WindowsX64__ 平台. 内置帧性能监控, 使用简单的控制反转(IOC), 降低游戏代码与框架的耦合度, 框架内置多级 后期处理调色&背景处理 着色器管线. 使用描述符(DESC), 描述各构建对象以及挂载组件, 简化手动创建等.

- __开发进度__ __V1:__ `▮▮▮▮▮▮▮▮▮▯` 92% __底层模块测试完善:__ `▮▮▯▯▯▯▯▯▯▯` 28%

FrameworkCore __Files:__ ```91``` __LoC:__ ```14128```
