...
namespace GraphicsEngineDataset {
	...
	void GLEngineStcVertexData::StaticVertexFrameDraw() {
		// draw static vertex.
		PsagLow::PsagSupGraphicsTool::PsagGraphicsFuncDrawModel(LLRES_VertexBuffers->ResourceFind(VertexBuffer));
	}

	void GLEngineStcVertexData::StaticVertexDataObjectCreate() {
		PSAG_SYSGEN_TIME_KEY GenResourceID;

		PsagLow::PsagSupGraphicsTool::PsagGraphicsModel VertexProcess;
	...
	bool GLEngineDyVertexData::VerOperFrameDraw(ResUnique strkey) {
		...
		if (it != IndexItems.end()) {
			...
			PsagLow::PsagSupGraphicsTool::PsagGraphicsFuncDrawVert(
	...
	void GLEngineDyVertexData::UpdateVertexDyDataset() {
		...
		PsagLow::PsagSupGraphicsTool::PsagGraphicsFuncUpdateModel(
	...
	PsagLow::PsagSupGraphicsTool::PsagGraphicsUniform GLEngineSmpTextureData::ShaderUniform = {};
	...
	bool GLEngineSmpTextureData::VirTextureItemAlloc(ResUnique strkey, const ImageRawData& image) {
		...
		if (!ImgDataTemp.ImagePixels.empty()) {
			...
			PsagLow::PsagSupGraphicsTool::PsagUploadTex::UploadTextureLayerRGBA(
	...
	bool GLEngineSmpTextureData::VirTextureItemAlloc(ResUnique strkey, const Vector2T<uint32_t>& size) {
	...
	bool GLEngineSmpTextureData::VirTextureItemDraw(ResUnique strkey, PsagShader shader, const VirTextureUniformName& uniform_name) {
		...
		if (TexItemTemp != nullptr) {
			...
			if (TexResourceTemp.Texture == OPENGL_INVALID_HANDEL)
				return false;
			PsagLow::PsagSupGraphicsTool::PsagGraphicsFuncTextureContextBind(TexResourceTemp);
	...
	void GLEngineSmpTextureData::VirtualTextureDataObjectCreate(
		...
		PsagLow::PsagSupGraphicsTool::PsagGraphicsTexture TextureCreate8X;
		PsagLow::PsagSupGraphicsTool::PsagGraphicsTexture TextureCreate4X;
		PsagLow::PsagSupGraphicsTool::PsagGraphicsTexture TextureCreate2X;
		PsagLow::PsagSupGraphicsTool::PsagGraphicsTexture TextureCreate1X;
