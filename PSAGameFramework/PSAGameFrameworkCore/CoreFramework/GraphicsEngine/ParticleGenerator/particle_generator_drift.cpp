...
namespace GraphicsEngineParticle {
	bool GeneratorDriftDown::ConfigCreateNumber(float number) {
	...
	void GeneratorDriftDown::ConfigLifeDispersion(const Vector2T<float>& rand_life) {
	...
	void GeneratorDriftDown::ConfigSizeDispersion(const Vector2T<float>& rand_size) {
